...
export const translations: Translations = {
  ...
  'catalog.sim_iot_telemetry': { en: 'Cellular IoT Telemetry', es: 'Telemetría Celular IoT' },
  'catalog.sim_headline': { en: 'Global PoC SIM Cards & Coverage Rates', es: 'Tarjetas SIM PoC Globales y Cobertura' },
  'catalog.sim_lead': {
    en: 'All G-TECH PoC devices operate via encrypted cellular networks with zero distance limits. You can bundle your hardware order with pre-configured, multi-carrier SIM cards providing uninterrupted Tier-1 roaming.',
    es: 'Todos los equipos PoC de G-TECH operan a través de redes celulares cifradas sin límites de distancia. Puedes incluir en tu pedido tarjetas SIM multi-operador preconfiguradas con roaming Tier-1 sin interrupciones.'
  },
  'catalog.us_canada': { en: 'United States & Canada', es: 'Estados Unidos y Canadá' },
  'catalog.us_canada_carriers': { en: 'Tier-1 Multi-Carrier: AT&T, Verizon & T-Mobile', es: 'Multi-Operador Tier-1: AT&T, Verizon y T-Mobile' },
  'catalog.latam': { en: 'Latin America (Pan-Regional)', es: 'Latinoamérica (Pan-Regional)' },
  'catalog.latam_carriers': { en: 'Auto-Hopping: Movistar, Claro, Digitel & Entel', es: 'Conmutación Automática: Movistar, Claro, Digitel y Entel' },
  'catalog.europe': { en: 'Europe & United Kingdom', es: 'Europa y Reino Unido' },
  'catalog.europe_carriers': { en: 'Full EU Roaming: Vodafone, Telefónica & EE', es: 'Roaming Completo UE: Vodafone, Telefónica y EE' },
  'catalog.global_imsi': { en: 'Global Multi-IMSI (140+ Countries)', es: 'Multi-IMSI Global (140+ Países)' },
  'catalog.global_carriers': { en: 'Defense & Maritime Global Data Roaming', es: 'Roaming Global para Defensa y Marítimo' },
  'catalog.per_month': { en: '/mo', es: '/mes' },
  'catalog.per_year_save': { en: '/year (Save 17%)', es: '/año (Ahorro 17%)' },
  'catalog.feat_activation': { en: 'Zero Activation Fees', es: 'Sin Costos de Activación' },
  'catalog.feat_aes': { en: 'AES-256 Voice Tunnel', es: 'Túnel de Voz AES-256' },
  'catalog.feat_apn': { en: 'Pre-Configured APN', es: 'APN Pre-Configurado' },
  ...
  'catalog.feat_cancel': { en: 'Cancel Anytime', es: 'Cancela en Cualquier Momento' },
  'catalog.inquire_sim_whatsapp': { en: 'Inquire Hardware + SIM via WhatsApp', es: 'Cotizar Equipo + SIM por WhatsApp' },
